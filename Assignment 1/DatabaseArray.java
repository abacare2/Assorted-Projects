...
public class DatabaseArray 
{
	...
	public String toString(int position)		//calls our toString from the DatabaseRecord class to print the contents of the dataRecord at (position) in array
	{
		return dataRecord(position).toString;
	}
	
	//we need to be able to seperately return the first name, last name, and id so that we may create a list By First...etc
