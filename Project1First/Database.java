...
public class Database 
{
	...
	public void insert(String i, String f, String l)
	{
		...
		IndexRecord id = new IndexRecord(i, myDbArr.getPosition());
		IndexRecord first = new IndexRecord(f,  myDbArr.getPosition());
		IndexRecord last = new IndexRecord(l,  myDbArr.getPosition());
